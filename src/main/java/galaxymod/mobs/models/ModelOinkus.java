...
public class ModelOinkus extends ModelBase {
	...
	public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_,
		...
		if (this.isChild) {
			float f6 = 2.0F;
			GL11.glPushMatrix();
			GL11.glTranslatef(0.0F, this.field_78145_g * p_78088_7_,
					this.field_78151_h * p_78088_7_);
	...
	public void setRotationAngles(float p_78087_1_, float p_78087_2_,
		...
		this.cheekThingLeft.rotateAngleX = p_78087_5_
				/ (180F / (float) Math.PI);
		this.cheekThingLeft.rotateAngleY = p_78087_4_
				/ (180F / (float) Math.PI);
		this.cheekThingRight.rotateAngleX = p_78087_5_
				/ (180F / (float) Math.PI);
		this.cheekThingRight.rotateAngleY = p_78087_4_
				/ (180F / (float) Math.PI);
