...
public class BlockZollusKriffonPortal extends BlockPortal {
	
	public BlockZollusKriffonPortal() {
		ZGHelper.setNameAndTexture(this, "zolluskriffonportal");
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.blockIcon = p_149651_1_
				.registerIcon("galaxymod:zolluskriffonportal");
	}
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3,
		...
		if (par5Entity.ridingEntity == null
			...
			} else if (player.dimension != ConfigManagerZG.planetKriffonDimensionId) {
				player.timeUntilPortal = 10;
				...
				player.mcServer
						...
						.transferPlayerToDimension(
								...
								new TeleporterZollusKriffon(
										mServer.worldServerForDimension(ConfigManagerZG.planetKriffonDimensionId)));
			} else {
				player.timeUntilPortal = 10;
				player.mcServer
						.getConfigurationManager()
						.transferPlayerToDimension(
								player,
								ConfigManagerZG.planetZollusDimensionId,
								new TeleporterZollusKriffon(
										mServer.worldServerForDimension(ConfigManagerZG.planetZollusDimensionId)));
			}
		}
	}
	...
	public boolean func_150000_e(World par1World, int par2, int par3, int par4) {
		...
		if (par1World.getBlock(par2 - 1, par3, par4) == BlockList.kriffRock
				|| par1World.getBlock(par2 + 1, par3, par4) == BlockList.kriffRock) {
			b0 = 1;
		}
		
		if (par1World.getBlock(par2, par3, par4 - 1) == BlockList.kriffRock
				|| par1World.getBlock(par2, par3, par4 + 1) == BlockList.kriffRock) {
			b1 = 1;
		}
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3,
		...
		if (par1World.getBlock(par2, i1 - 1, par4) != BlockList.kriffRock) {
			...
			if (j1 == 3
					&& par1World.getBlock(par2, i1 + j1, par4) == BlockList.kriffRock) {
				...
				if (flag && flag1) {
					...
					if ((par1World.getBlock(par2 + b0, par3, par4 + b1) != BlockList.kriffRock || par1World
							.getBlock(par2 - b0, par3, par4 - b1) != this)
							&& (par1World.getBlock(par2 - b0, par3, par4 - b1) != BlockList.kriffRock || par1World
									.getBlock(par2 + b0, par3, par4 + b1) != this)) {
						par1World.setBlockToAir(par2, par3, par4);
					}
				}
