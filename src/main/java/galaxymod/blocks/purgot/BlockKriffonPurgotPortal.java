...
import galaxymod.dimensions.providers.kriffon.TeleporterKriffonPurgot;
...
public class BlockKriffonPurgotPortal extends BlockPortal {
	
	public BlockKriffonPurgotPortal() {
		ZGHelper.setNameAndTexture(this, "kriffonpurgotportal");
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.blockIcon = p_149651_1_
				.registerIcon("galaxymod:kriffonpurgotportal");
	}
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3,
		...
		if (par5Entity.ridingEntity == null
			...
			} else if (player.dimension != ConfigManagerZG.planetPurgotDimensionId) {
				player.timeUntilPortal = 10;
	...
	public boolean func_150000_e(World par1World, int par2, int par3, int par4) {
		...
		if (par1World.getBlock(par2 - 1, par3, par4) == BlockList.purgRock
				|| par1World.getBlock(par2 + 1, par3, par4) == BlockList.purgRock) {
			b0 = 1;
		}
		
		if (par1World.getBlock(par2, par3, par4 - 1) == BlockList.purgRock
				|| par1World.getBlock(par2, par3, par4 + 1) == BlockList.purgRock) {
			b1 = 1;
		}
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3,
		...
		if (par1World.getBlock(par2, i1 - 1, par4) != BlockList.purgRock) {
			...
			if (j1 == 3
					&& par1World.getBlock(par2, i1 + j1, par4) == BlockList.purgRock) {
				...
				if (flag && flag1) {
					...
					if ((par1World.getBlock(par2 + b0, par3, par4 + b1) != BlockList.purgRock || par1World
							.getBlock(par2 - b0, par3, par4 - b1) != this)
							&& (par1World.getBlock(par2 - b0, par3, par4 - b1) != BlockList.purgRock || par1World
									.getBlock(par2 + b0, par3, par4 + b1) != this)) {
						par1World.setBlockToAir(par2, par3, par4);
					}
				}
