...
public class BlockEdenWoodLeaves extends BlockLeavesBase implements IShearable {
	...
	public BlockEdenWoodLeaves() {
		...
		ZGHelper.setNameAndTexture(this, "edenwoodleaves");
	...
	public Item getItemDropped(int par1, Random par2Random, int par3) {
		return Item.getItemFromBlock(BlockList.edenWoodSapling);
	}
