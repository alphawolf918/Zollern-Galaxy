...
public class EdenViriOre extends BlockNova {
	
	public static Item dropItem = ItemList.rawViri;
	
	public EdenViriOre() {
		super(Material.rock);
		this.setNameAndTexture("edenviriore");
	...
	public int getExpDrop(IBlockAccess p_149690_1_, int p_149690_5_,
		...
		if (this.getItemDropped(p_149690_5_, rand, p_149690_7_) != Item
			...
			int j1 = 0;
			j1 = MathHelper.getRandomIntegerInRange(rand, 6, 14);
