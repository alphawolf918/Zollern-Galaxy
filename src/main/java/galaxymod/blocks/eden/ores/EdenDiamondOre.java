...
public class EdenDiamondOre extends BlockNova {
	
	public static Item dropItem = Items.diamond;
	
	public EdenDiamondOre() {
		super(Material.rock);
		this.setBlockName(ModInfo.MODID + "_edendiamondore");
		this.setBlockTextureName(ModInfo.MODID + ":edendiamondore");
