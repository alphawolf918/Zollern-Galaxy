...
public class BlockEdenGoldenGrass extends BlockNova {
	
	private IIcon[] edenGrassIcon;
	public IIcon blockIcon;
	
	public BlockEdenGoldenGrass() {
		super(Material.grass);
		this.setBlockName("galaxymod_edengoldengrass");
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		this.edenGrassIcon = new IIcon[7];
		this.edenGrassIcon[0] = par1IconRegister
				.registerIcon("galaxymod:edensoil");
		this.edenGrassIcon[1] = par1IconRegister
				.registerIcon("galaxymod:edengoldengrass");
		this.edenGrassIcon[2] = par1IconRegister
				.registerIcon("galaxymod:edengoldengrass_side");
		this.edenGrassIcon[3] = par1IconRegister
				.registerIcon("galaxymod:edengoldengrass_side");
		this.edenGrassIcon[4] = par1IconRegister
				.registerIcon("galaxymod:edengoldengrass_side");
		this.edenGrassIcon[5] = par1IconRegister
				.registerIcon("galaxymod:edengoldengrass_side");
		this.edenGrassIcon[6] = par1IconRegister
				.registerIcon("galaxymod:edengoldengrass_side");
