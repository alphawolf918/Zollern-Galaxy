...
public class SkyProviderPurgot extends IRenderHandler {
	...
	public SkyProviderPurgot(IGalacticraftWorldProvider gcProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		WorldProviderPurgot gcProvider = null;
		
		if (world.provider instanceof WorldProviderPurgot) {
			gcProvider = (WorldProviderPurgot) world.provider;
		}
