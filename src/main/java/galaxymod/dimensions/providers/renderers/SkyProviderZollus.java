...
public class SkyProviderZollus extends IRenderHandler {
	...
	public SkyProviderZollus(IGalacticraftWorldProvider gcProvider) {
		this.sunSize = 8F * gcProvider.getSolarSize();
		GL11.glPushMatrix();
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		WorldProviderZollus gcProvider = null;
		
		if (world.provider instanceof WorldProviderZollus) {
			gcProvider = (WorldProviderZollus) world.provider;
		}
		...
		double var25 = mc.thePlayer.getPosition(partialTicks).yCoord
				- world.getHorizon();
