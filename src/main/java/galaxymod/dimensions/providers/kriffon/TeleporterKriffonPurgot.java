...
public class TeleporterKriffonPurgot extends Teleporter {
	...
	public TeleporterKriffonPurgot(WorldServer par1WorldServer) {
				...
				for (int i1 = -2; i1 <= 2; ++i1) {
					for (int j1 = -1; j1 < 3; ++j1) {
						...
						this.worldServerInstance.setBlock(k1, l1, i2,
								flag ? BlockList.purgRock : Blocks.air);
					}
				}
			}
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2,
			...
			for (k1 = l - short1; k1 <= l + short1; ++k1) {
				...
				for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1) {
					...
					for (int i2 = this.worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2) {
						if (this.worldServerInstance.getBlock(k1, i2, l1) == BlockList.kriffonPurgotPortal) {
							while (this.worldServerInstance.getBlock(k1,
									i2 - 1, l1) == BlockList.kriffonPurgotPortal) {
								--i2;
							}
		...
		if (d3 >= 0.0D) {
			...
			if (this.worldServerInstance.getBlock(i - 1, j, k) == BlockList.kriffonPurgotPortal) {
				j2 = 2;
			}
			...
			if (this.worldServerInstance.getBlock(i, j, k - 1) == BlockList.kriffonPurgotPortal) {
				j2 = 3;
			}
		...
		for (k2 = 0; k2 < 4; ++k2) {
			for (i3 = 0; i3 < 4; ++i3) {
				for (l2 = -1; l2 < 4; ++l2) {
					...
					this.worldServerInstance.setBlock(k3, j3, i4,
							flag ? BlockList.purgRock
									: BlockList.kriffonPurgotPortal, 0, 2);
				}
			}
