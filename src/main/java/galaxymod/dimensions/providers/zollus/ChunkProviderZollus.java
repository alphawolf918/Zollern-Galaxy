...
public class ChunkProviderZollus extends ChunkProviderGenerate {
	...
	private MapGenCavesZollus caveGenerator;
	// private MapGenCavernZollus cavernGenerator;
	public BiomeDecoratorZollusOre biomedecoratorplanet = new BiomeDecoratorZollusOre();
	// private MapGenZollusVillage villageGenerator = new MapGenZollusVillage();
	private MapGenZollusRavine ravineGenerator = new MapGenZollusRavine();
	...
	public ChunkProviderZollus(World world, long seed, boolean flag) {
		super(world, seed, flag);
		this.stoneNoise = new double[256];
		this.caveGenerator = new MapGenCavesZollus();
		// this.cavernGenerator = new MapGenCavernZollus();
		this.worldObj = world;
	...
	public List getPossibleCreatures(EnumCreatureType type, int x, int y, int z) {
		if (type == EnumCreatureType.monster) {
			...
			monsters.add(new SpawnListEntry(EntityFrostGiant.class, 20, 1, 2));
			return monsters;
		}
		return null;
	}
