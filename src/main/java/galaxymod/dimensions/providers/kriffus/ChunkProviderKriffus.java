...
public class ChunkProviderKriffus extends ChunkProviderSpace {
	...
	public ChunkProviderKriffus(World world, long seed, boolean flag) {
	...
	protected BiomeDecoratorSpace getBiomeGenerator() {
		return this.kriffonBiomeDecorator;
	}
	
	@Override
	protected BiomeGenBase[] getBiomesForGeneration() {
		return new BiomeGenBase[] { BiomeList.biomeKriffus };
	}
	...
	protected BlockMetaPair getDirtBlock() {
		return new BlockMetaPair(BlockList.kriffDirt, (byte) 0);
	}
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
		...
		if (this.rand.nextInt(4) == 0
			...
			new WorldGenEdenLakes(Blocks.lava).generate(this.worldObj,
					this.rand, k1, l1, i2);
		}
	...
	public void decoratePlanet(World par1World, Random par2Random, int par3,
			int par4) {
		this.kriffonBiomeDecorator.decorate(par1World, par2Random, par3, par4);
	}
