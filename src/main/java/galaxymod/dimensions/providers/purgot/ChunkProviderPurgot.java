...
public class ChunkProviderPurgot extends ChunkProviderSpace {
	...
	protected BiomeDecoratorSpace getBiomeGenerator() {
		return this.purgotBiomeDecorator;
	}
	...
	public void decoratePlanet(World par1World, Random par2Random, int par3,
			int par4) {
		this.purgotBiomeDecorator.decorate(par1World, par2Random, par3, par4);
	}
