...
public class ChunkProviderPurgot extends ChunkProviderGenerate {
	...
	private MapGenCavesPurgot caveGenerator;
	public BiomeDecoratorPurgotOre biomedecoratorplanet = new BiomeDecoratorPurgotOre();
	private MapGenPurgotRavine ravineGenerator = new MapGenPurgotRavine();
	...
	public ChunkProviderPurgot(World world, long seed, boolean flag) {
		super(world, seed, flag);
		this.stoneNoise = new double[256];
		this.caveGenerator = new MapGenCavesPurgot();
		this.worldObj = world;
