...
public class TeleporterPurgotOasis extends Teleporter {
	...
	public TeleporterPurgotOasis(WorldServer par1WorldServer) {
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2,
			...
			for (k1 = l - short1; k1 <= l + short1; ++k1) {
				...
				for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1) {
					...
					for (int i2 = this.worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2) {
						if (this.worldServerInstance.getBlock(k1, i2, l1) == BlockList.purgotOasisPortal) {
							while (this.worldServerInstance.getBlock(k1,
									i2 - 1, l1) == BlockList.purgotOasisPortal) {
								--i2;
							}
		...
		if (d3 >= 0.0D) {
			...
			if (this.worldServerInstance.getBlock(i - 1, j, k) == BlockList.purgotOasisPortal) {
				j2 = 2;
			}
			...
			if (this.worldServerInstance.getBlock(i, j, k - 1) == BlockList.purgotOasisPortal) {
				j2 = 3;
			}
				...
				for (l2 = -1; l2 < 4; ++l2) {
					...
					this.worldServerInstance.setBlock(k3, j3, i4,
							flag ? BlockList.purgRock
									: BlockList.purgotOasisPortal, 0, 2);
				}
			}
