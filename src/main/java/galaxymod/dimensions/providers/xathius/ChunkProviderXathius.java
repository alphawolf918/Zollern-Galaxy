...
public class ChunkProviderXathius extends ChunkProviderSpace {
	...
	public ChunkProviderXathius(World world, long seed, boolean flag) {
	...
	protected BiomeDecoratorSpace getBiomeGenerator() {
		return this.xathiusBiomeDecorator;
	}
	
	@Override
	protected BiomeGenBase[] getBiomesForGeneration() {
		return new BiomeGenBase[] { BiomeList.biomeXathius,
				BiomeList.biomeXathiusAbstractPlains };
	}
	
	@Override
	protected BlockMetaPair getGrassBlock() {
		return new BlockMetaPair(BlockList.xathRock, (byte) 0);
	}
	
	@Override
	protected BlockMetaPair getDirtBlock() {
		return new BlockMetaPair(BlockList.xathDirt, (byte) 0);
	}
	
	@Override
	protected BlockMetaPair getStoneBlock() {
		return new BlockMetaPair(BlockList.xathStone, (byte) 0);
	}
	...
	public void decoratePlanet(World par1World, Random par2Random, int par3,
			int par4) {
		this.xathiusBiomeDecorator.decorate(par1World, par2Random, par3, par4);
	}
