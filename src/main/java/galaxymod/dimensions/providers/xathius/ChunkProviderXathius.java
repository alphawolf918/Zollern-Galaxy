...
public class ChunkProviderXathius extends ChunkProviderGenerate {
	...
	private MapGenCavesXathius caveGenerator;
	public BiomeDecoratorXathiusOre biomedecoratorplanet = new BiomeDecoratorXathiusOre();
	private MapGenXathiusRavine ravineGenerator = new MapGenXathiusRavine();
	...
	public ChunkProviderXathius(World world, long seed, boolean flag) {
		...
		this.caveGenerator = new MapGenCavesXathius();
		this.worldObj = world;
