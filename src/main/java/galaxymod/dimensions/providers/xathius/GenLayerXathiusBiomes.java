...
public class GenLayerXathiusBiomes extends GenLayer {
	
	protected BiomeGenBase[] commonBiomes = { BiomeList.biomeXathius };
	protected BiomeGenBase[] rareBiomes = { BiomeList.biomeXathiusAbstractPlains };
	
	public GenLayerXathiusBiomes(long seed, GenLayer genlayer) {
		super(seed);
