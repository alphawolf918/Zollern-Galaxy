...
public class RoomSpawnerEden extends DungeonRoom {
	...
	public RoomSpawnerEden(MapGenDungeon dungeon, int posX, int posY, int posZ,
	...
	protected DungeonRoom makeRoom(MapGenDungeon dungeon, int x, int y, int z,
			ForgeDirection dir) {
		return new RoomSpawnerEden(dungeon, x, y, z, dir);
	}
