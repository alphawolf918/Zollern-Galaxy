...
package galaxymod.worldgen.kriffon;
...
public class MapGenCavernKriffon extends MapGenBaseMeta {
								...
								for (int var50 = caveMaxY - 1; var50 >= caveMinY; --var50) {
									...
									if (var59 * var59 + var51 * var51 + var46
										...
										if (var51 > -0.7D) {
											...
											if (arrayOfIDs[coords] == BlockList.kriffStone) {
									...
									if (var59 * var59 + var51 * var51 + var46
										...
										if (var51 > -0.7D) {
											...
											if (Blocks.air == arrayOfIDs[coords]) {
												if (arrayOfIDs[coordsAbove] == BlockList.kriffStone
														&& this.rand
																.nextInt(200) == 0) {
													int modifier = 0;
