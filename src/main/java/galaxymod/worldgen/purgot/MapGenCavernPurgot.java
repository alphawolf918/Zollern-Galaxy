...
package galaxymod.worldgen.purgot;
...
public class MapGenCavernPurgot extends MapGenBaseMeta {
								...
								for (int var50 = caveMaxY - 1; var50 >= caveMinY; --var50) {
									...
									if (var59 * var59 + var51 * var51 + var46
										...
										if (var51 > -0.7D) {
											...
											if (arrayOfIDs[coords] == BlockList.purgStone) {
									...
									if (var59 * var59 + var51 * var51 + var46
										...
										if (var51 > -0.7D) {
											...
											if (Blocks.air == arrayOfIDs[coords]) {
												if (arrayOfIDs[coordsAbove] == BlockList.purgStone
														&& this.rand
																.nextInt(200) == 0) {
													int modifier = 0;
