...
package galaxymod.items.kriffon;
...
public class ItemKriffonTablet extends ItemNova {
	
	public ItemKriffonTablet() {
		super("kriffonpurgottablet");
		this.setMaxDamage(4);
	}
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world,
		...
		if (!world.isRemote) {
			world.setBlock(par4, par5, par6, BlockList.kriffonPurgotPortal);
