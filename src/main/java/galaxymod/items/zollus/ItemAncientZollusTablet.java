...
package galaxymod.items.zollus;
...
public class ItemAncientZollusTablet extends ItemNova {
	
	public ItemAncientZollusTablet() {
		super("zolluskriffontablet");
		this.setMaxDamage(4);
	}
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world,
		...
		if (!world.isRemote) {
			world.setBlock(par4, par5, par6, BlockList.zollusKriffonPortal);
