...
package galaxymod.items.purgot;
...
public class ItemPurgotTablet extends ItemNova {
	
	public ItemPurgotTablet() {
		super("purgotoasistablet");
		this.setMaxDamage(4);
	}
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world,
		...
		if (!world.isRemote) {
			world.setBlock(par4, par5, par6, BlockList.purgotOasisPortal);
