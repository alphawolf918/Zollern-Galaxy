...
public class RandPosGenBug {
	 ...
	 */
	@Nullable
	public static Vec3d findRandomTarget(EntityBugZG entitycreatureIn, int xz, int y) {
		return findRandomTargetBlock(entitycreatureIn, xz, y, (Vec3d) null);
	}
	
	@Nullable
	public static Vec3d getLandPos(EntityBugZG p_191377_0_, int p_191377_1_, int p_191377_2_) {
	 ...
	 */
	@Nullable
	public static Vec3d findRandomTargetBlockTowards(EntityBugZG entitycreatureIn, int xz, int y, Vec3d targetVec3) {
	 ...
	 */
	@Nullable
	public static Vec3d findRandomTargetBlockAwayFrom(EntityBugZG entitycreatureIn, int xz, int y, Vec3d targetVec3) {
	 ...
	 */
	@Nullable
	private static Vec3d findRandomTargetBlock(EntityBugZG entitycreatureIn, int xz, int y, @Nullable Vec3d targetVec3) {
	...
	private static BlockPos moveAboveSolid(BlockPos p_191378_0_, EntityBugZG p_191378_1_) {
	...
	private static boolean isWaterDestination(BlockPos p_191380_0_, EntityBugZG p_191380_1_) {
