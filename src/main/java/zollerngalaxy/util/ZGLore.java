...
public class ZGLore {
	...
	public static void init() {
		...
		BOOK_FOUR = ZGLore.createLoreBook(4, "The Grays", "The Grays are a race of extraterrestrials " + "from an unknown dimension.",
				...
				"It is believed that the Grays visited Earth long ago, "
		...
		BOOK_THIRTYFIVE = ZGLore.createLoreBook(35, "Planet Perdita", "Perdita is the planet of loss. ",
				"Though it is beautiful and magestic, it carries with it a heavy history.",
		...
		BOOK_THIRTYEIGHT = ZGLore.createLoreBook(38, "Mega Creepers",
				"Mega Creepers... These terrifying beings... By the stars, I wish them dead.", "Ayanna, what have you done?",
				"Their explosions are growing; their speed, increasing.", "I fear that these creatures could destroy planets! ",
