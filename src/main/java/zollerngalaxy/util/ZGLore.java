...
public class ZGLore {
	...
	public static void init() {
		...
		BOOK_THREE = ZGLore.createLoreBook(3, "Tech Planets", "Planets Xantheon and Atheon are artificial planets that were created by the Grays.",
				...
				"They also contain resources with extreme value.",
				"Constructed planets were created from asteroids, " + "using the energy of a Dyson sphere and arduous terraforming.",
		...
		BOOK_FOUR = ZGLore.createLoreBook(4, "The Grays", "The Grays are a race of extraterrestrials " + "from an unknown dimension.",
				"They are incredibly smart, and though not hostile, " + " they should be considered enemies to the Player.",
				...
				"It is believed that the Grays visited Earth long ago, " + "and actually interfered with human DNA, intertwining their own with a "
		...
		BOOK_FIVE = ZGLore.createLoreBook(5, "Super Charged Coal",
				...
				"Due to the electric current, these cavemen received a drastic boost in their intelligence, "
						+ "and began evolving rapidly, leaving their star system and " + "exploring others within under 100 years.",
		...
		BOOK_SEVEN = ZGLore.createLoreBook(7, "Planet Eden", "Eden is a paradise planet in the Psios-6 system.",
				"It orbits a blue star with its three other planetary neighbors.", "It is a multi-biome planet with unique fauna and environmental factors.",
		...
		BOOK_EIGHT = ZGLore.createLoreBook(8, "Planet Zollus", "Zollus is a barren, icy planet, and the home of the Frost Giants.",
				...
				"Zollus Crystals grow here, which are believed to have been formed " + "from the planet's crust in its conception.",
		...
		BOOK_NINE = ZGLore.createLoreBook(9, "Planet Kriffon", "Kriffon is a bright but gloomy hellscape, " + "populated by volcanic entities called the Magmos.",
				...
				"The planet was named after the Kriff: " + "a race of red-skinned entities that drove their planet to extinction with their rapid evolution "
		...
		BOOK_TEN = ZGLore.createLoreBook(10, "Planet Purgot", "Purgot was once believed to be a separate dimension called Purgatory.",
				...
				"The primary metal here is Evenium, " + "and can be found deep inside of its caves.", "Ancient astronauts used to tell stories to "
		...
		BOOK_ELEVEN = ZGLore.createLoreBook(11, "Planet Xathius", "Xathius is a strange but beautiful planet, " + "located in the Praedyth system.",
				...
				"Xathius is primarily known for its abundance of Promethean Ore, " + "which is a very powerful metal in the creation of Star Gates.",
		...
		BOOK_FOURTEEN = ZGLore.createLoreBook(14, "Planet Candora",
				...
				"It is filled with a Candy Cube landscape, " + "and has an ocean comprised entirely of melted chocolate.", "No one knows how this is even possible.",
				"It usually is used as a partying planet, " + "and one of celebration.", "Many sweets can be found here, as can many strange anomalies.");
		...
		BOOK_TWENTY = ZGLore.createLoreBook(20, "Planet Caligro", "Caligro was once a paradise planet like Oasis.",
				...
				"But, something had occurred on this planet.", "The darkness had consumed it entirely.", "It was no longer a place of beauty, but of death and gloom.",
				"Its old name was Forma, named for its beauty.", "But now... Now it brought death to all who set " + "foot upon it.",
		...
		BOOK_TWENTYTWO = ZGLore.createLoreBook(22, "Class H Planets", "Class H planets are a characteristically lifeless planet, uninhabitable by humans.",
		...
		BOOK_TWENTYSIX = ZGLore.createLoreBook(26, "Class M Planets",
				...
				"These worlds are usually abundant with water, flora, and fauna," + " with a core rich in Nickel and Iron.",
				"Some of these worlds can emit electromagnetic radiation.", "Usually has its own entire ecosystem and amino acids.");
		...
		BOOK_TWENTYNINE = ZGLore.createLoreBook(29, "Class R Planets", "Class R planets are a lesser bioclassification of a Class M planet,"
				+ " these worlds are generally habitable, " + "however they lack some or most of the characteristics for a terrestrial planet.");
		
		BOOK_THIRTY = ZGLore
				.createLoreBook(30,
						"Class Y Planets", "Class Y planets are a world characterized by a toxic atmosphere, "
								+ "thermionic radiation discharges and surface temperatures " + "at or above five hundred Kelvin, " + "nicknamed the \"demon class.\"",
		...
		BOOK_THIRTYFOUR = ZGLore.createLoreBook(34, "Metamorphasis 1",
				...
				"It should also be noted that drastic changes have affected Kriffon and Zollus.", "They seem to be undergoing some kind of metamorphasis.",
				"End log. - Star Captain Hohen");
		
		BOOK_THIRTYFIVE = ZGLore.createLoreBook(35, "Planet Perdita", "Perdita is the planet of loss. ",
				"Though it is beautiful and magestic, it carries with it a heavy history.", "Many lost souls ended up in this world, and were converted to Dark Agents.",
		...
		BOOK_THIRTYSEVEN = ZGLore.createLoreBook(37, "Scorpions", "Scorpions are a new breed of spider evolution.",
				"They are said to have evolved from Cave Spiders who were dumped on Perdita.",
				"Darkness envelops these creatures as well, and they are incredibly poisonous.");
		
		BOOK_THIRTYEIGHT = ZGLore.createLoreBook(38, "Mega Creepers", "Mega Creepers... These terrifying beings... By the stars, I wish them dead.",
				"Ayanna, what have you done?", "Their explosions are growing; their speed, increasing.", "I fear that these creatures could destroy planets! ",
				"Oh, my lover, I am so sorry.", "Perhaps if I can find you, we can discuss your pain.", "We can end this. I'm on my way.",
				"Please, still have some humanity left in you. - Star Captain Hohen");
		
		BOOK_THIRTYNINE = ZGLore.createLoreBook(39, "Metamorphasis 2", "The metamorphasis is rapidly increasing.",
				"Zollus and Kriffon, they... they've completely changed.", "The worlds have rewrote themselves.",
		...
		BOOK_FOURTYTHREE = ZGLore.createLoreBook(43, "Dark Arrival 3",
				...
				"\"A sailor among the stars, ever so entranced by their luminescence.", "You seek answers to something that you could not possibly understand.",
