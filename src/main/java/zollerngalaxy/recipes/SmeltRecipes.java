...
public class SmeltRecipes {
	...
	public static void init() {
		...
		SmeltRecipes.SmeltBlockToItem(ZGBlocks.zolCopperOre, new ItemStack(GCItems.basicItem, 1, 3), 2.4F); // Copper
		SmeltRecipes.SmeltBlockToItem(ZGBlocks.zolTinOre, new ItemStack(GCItems.basicItem, 1, 4), 2.4F); // Tin
		...
		SmeltRecipes.SmeltBlockToItem(ZGBlocks.kriffCopperOre, new ItemStack(GCItems.basicItem, 1, 3), 2.4F); // Copper
		...
		SmeltRecipes.SmeltBlockToItem(ZGBlocks.purgLeadOre, new ItemStack(VenusItems.basicItem, 1, 1), 2.4F); // Lead
		SmeltRecipes.SmeltBlockToItem(ZGBlocks.purgCopperOre, new ItemStack(GCItems.basicItem, 1, 3), 2.4F); // Copper
		...
		SmeltRecipes.SmeltBlockToItem(ZGBlocks.edenCopperOre, new ItemStack(GCItems.basicItem, 1, 3), 2.4F); // Copper
		SmeltRecipes.SmeltBlockToItem(ZGBlocks.edenTinOre, new ItemStack(GCItems.basicItem, 1, 4), 2.4F); // Tin
		...
		if (ModHelperBase.useCofh && ModHelperBase.useThermalFoundation) {
			...
			SmeltRecipes.SmeltBlockToItem(ZGBlocks.edenBronzeOre,
					new ItemStack(ItemHelper.getItemFromStack(TFItems.itemMaterial.ingotBronze), 1, 163), 4.2F); // Bronze
			SmeltRecipes.SmeltBlockToItem(ZGBlocks.edenElectrumOre,
					new ItemStack(ItemHelper.getItemFromStack(TFItems.itemMaterial.ingotElectrum), 1, 161), 4.2F); // Electrum
			SmeltRecipes.SmeltBlockToItem(ZGBlocks.edenInvarOre,
					new ItemStack(ItemHelper.getItemFromStack(TFItems.itemMaterial.ingotInvar), 1, 162), 4.2F); // Invar
