...
public class ZGInfo {
	...
	public static final String vBUILD = "6";
	...
	public static final String FORGE_MODS = "before:planetprogression@[1.12.2-0.3.8,];";
	...
	public static final String DEPENDENCIES = "required-after:galacticraftcore@[4.0.2.-1,);"
			+ "required-after:galacticraftplanets@[4.0.2.-1,); required-after:micdoodlecore; " + ZGInfo.FORGE_VERSION
			+ ZGInfo.FORGE_MODS;
