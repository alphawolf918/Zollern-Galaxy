...
public class ZGInfo {
	...
	public static final String vBUILD = "2";
	...
	public static final String FORGE_MODS = "before:planetprogression; ";
	public static final String FORGE_VERSION = "after:forge@[14.23.1.2555,);";
	public static final String DEPENDENCIES = "required-after:galacticraftcore@[4.0.2.-1,);"
			+ "required-after:galacticraftplanets@[4.0.2.-1,); required-after:micdoodlecore; "
			+ ZGInfo.FORGE_MODS + ZGInfo.FORGE_VERSION;
