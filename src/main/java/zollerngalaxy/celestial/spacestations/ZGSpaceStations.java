...
public class ZGSpaceStations {
	...
	private static void registerSpaceStations() {
		...
		// Psios-6 (Kriffon)
		ZGSpaceStations.registerSpaceStation(KRIFFON_SPACE_STATION, "Kriffon Space Station", "_kriffon_orbit", WorldProviderOrbitKriffon.class,
				ConfigManagerZG.spaceStationKriffonId, ConfigManagerZG.spaceStationKriffonStaticId);
		...
		// Praedyth (Xathius)
		ZGSpaceStations.registerSpaceStation(XATHIUS_SPACE_STATION, "Xathius Space Station", "_xathius_orbit", WorldProviderOrbitXathius.class,
				ConfigManagerZG.spaceStationXathiusId, ConfigManagerZG.spaceStationXathiusStaticId);
		...
		// Praedyth (Xantheon)
		ZGSpaceStations.registerSpaceStation(XANTHEON_SPACE_STATION, "Xantheon Space Station", "_xantheon_orbit", WorldProviderOrbitXantheon.class,
				ConfigManagerZG.spaceStationXantheonId, ConfigManagerZG.spaceStationXantheonStaticId);
		
		// Praedyth (Candora)
		ZGSpaceStations.registerSpaceStation(CANDORA_SPACE_STATION, "Candora Space Station", "_candora_orbit", WorldProviderOrbitCandora.class,
				ConfigManagerZG.spaceStationCandoraId, ConfigManagerZG.spaceStationCandoraStaticId);
		...
		// Sol-2 (Perdita)
		ZGSpaceStations.registerSpaceStation(PERDITA_SPACE_STATION, "Perdita Space Station", "_perdita_orbit", WorldProviderOrbitPerdita.class,
				ConfigManagerZG.spaceStationPerditaId, ConfigManagerZG.spaceStationPerditaStaticId);
		...
		// Sol-2 (Caligro)
		ZGSpaceStations.registerSpaceStation(CALIGRO_SPACE_STATION, "Caligro Space Station", "_caligro_orbit", WorldProviderOrbitCaligro.class,
				ConfigManagerZG.spaceStationCaligroId, ConfigManagerZG.spaceStationCaligroStaticId);
		
		// Sol-2 (Exodus)
		ZGSpaceStations.registerSpaceStation(EXODUS_SPACE_STATION, "Exodus Space Station", "_exodus_orbit", WorldProviderOrbitExodus.class,
				ConfigManagerZG.spaceStationExodusId, ConfigManagerZG.spaceStationExodusStaticId);
	...
	private static void registerSpaceStation(ZGSpaceStation spaceStation, String stationName, String stationStringId, Class<? extends WorldProvider> providerClass,
			int stationId, int stationStaticId) {
