...
import zollerngalaxy.mobs.models.ModelAbyssalVillager;

@SideOnly(Side.CLIENT)
public class RenderAbyssalVillager extends RenderLiving<EntityAbyssalVillager> {
	
	private static final ResourceLocation villagerTexture = new ResourceLocation(ZGInfo.MOD_ID,
			"textures/entity/villagers/abyssalvillager.png");
