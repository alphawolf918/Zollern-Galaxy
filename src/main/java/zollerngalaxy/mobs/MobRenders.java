...
import zollerngalaxy.mobs.entities.projectiles.render.RenderSentinelLaser;
...
import zollerngalaxy.mobs.renders.villagers.RenderMavethVillager;
...
public final class MobRenders {
	...
	private static void renderProjectiles() {
		MobRenders.renderMob(EntitySentinelLaser.class, RenderSentinelLaser::new);
	}
