...
public class ModelMavethVillager extends ModelBase {
	...
	public ModelMavethVillager() {
		...
		Head.cubeList.add(new ModelBox(Head, 1, 3, -4.0F, -8.0F, -4.0F, 8, 8, 7, 0.0F, false));
		
		Body = new ModelRenderer(this);
		Body.setRotationPoint(0.0F, -24.0F, 0.0F);
		villager.addChild(Body);
		Body.cubeList.add(new ModelBox(Body, 26, 20, -1.0F, -0.75F, -2.0F, 2, 14, 4, 0.0F, false));
		
		Bones = new ModelRenderer(this);
		Bones.setRotationPoint(0.0F, 0.0F, 0.0F);
		Body.addChild(Bones);
		Bones.cubeList.add(new ModelBox(Bones, 22, 23, -5.0F, 1.0F, 0.0F, 10, 2, 1, 0.0F, false));
		Bones.cubeList.add(new ModelBox(Bones, 23, 21, -4.0F, 4.0F, 0.0F, 8, 2, 1, 0.0F, false));
		Bones.cubeList.add(new ModelBox(Bones, 23, 21, -3.0F, 7.0F, 0.0F, 6, 2, 1, 0.0F, false));
		Bones.cubeList.add(new ModelBox(Bones, 23, 21, -3.0F, 10.0F, 0.0F, 6, 2, 1, 0.0F, false));
		
		RightArm = new ModelRenderer(this);
		RightArm.setRotationPoint(-5.0F, -22.0F, 0.0F);
		villager.addChild(RightArm);
		RightArm.cubeList.add(new ModelBox(RightArm, 32, 48, -2.0F, -1.0F, -2.0F, 2, 11, 4, 0.0F, false));
		
		LeftArm = new ModelRenderer(this);
		LeftArm.setRotationPoint(5.0F, -22.0F, 0.0F);
		villager.addChild(LeftArm);
		LeftArm.cubeList.add(new ModelBox(LeftArm, 32, 46, 0.0F, -1.0F, -2.0F, 2, 11, 4, 0.0F, false));
		
		RightLeg = new ModelRenderer(this);
		RightLeg.setRotationPoint(-1.9F, -12.0F, 0.0F);
		villager.addChild(RightLeg);
		RightLeg.cubeList.add(new ModelBox(RightLeg, 33, 48, -2.1F, -1.0F, -2.0F, 2, 13, 4, 0.0F, true));
		
		LeftLeg = new ModelRenderer(this);
		LeftLeg.setRotationPoint(1.9F, -12.0F, 0.0F);
		villager.addChild(LeftLeg);
		LeftLeg.cubeList.add(new ModelBox(LeftLeg, 32, 47, 0.0F, -1.0F, -2.0F, 2, 13, 4, 0.0F, false));
	}
