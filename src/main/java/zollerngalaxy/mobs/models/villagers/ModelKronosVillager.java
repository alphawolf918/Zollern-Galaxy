...
public class ModelKronosVillager extends ModelBase {
	...
	public ModelKronosVillager() {
		...
		RightArm.cubeList.add(new ModelBox(RightArm, 33, 20, -3.0F, -2.0F, -2.0F, 4, 14, 4, 0.0F, false));
		
		LeftArm = new ModelRenderer(this);
		LeftArm.setRotationPoint(5.0F, -22.0F, 0.0F);
		villager.addChild(LeftArm);
		LeftArm.cubeList.add(new ModelBox(LeftArm, 33, 20, -1.0F, -2.0F, -2.0F, 4, 14, 4, 0.0F, false));
		
		RightLeg = new ModelRenderer(this);
		RightLeg.setRotationPoint(-1.9F, -12.0F, 0.0F);
		villager.addChild(RightLeg);
		RightLeg.cubeList.add(new ModelBox(RightLeg, 33, 22, -2.1F, 0.0F, -2.0F, 4, 12, 4, 0.0F, true));
		
		LeftLeg = new ModelRenderer(this);
		LeftLeg.setRotationPoint(1.9F, -12.0F, 0.0F);
		villager.addChild(LeftLeg);
		LeftLeg.cubeList.add(new ModelBox(LeftLeg, 33, 22, -2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F, false));
	}
