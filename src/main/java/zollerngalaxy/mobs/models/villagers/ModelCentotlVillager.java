...
public class ModelCentotlVillager extends ModelBase {
	...
	public ModelCentotlVillager() {
		...
		Head.cubeList.add(new ModelBox(Head, 28, 46, -4.0F, -11.0F, -4.0F, 8, 11, 8, 0.0F, false));
		...
		RightArm.cubeList.add(new ModelBox(RightArm, 0, 22, -4.0F, -2.0F, -2.0F, 5, 12, 4, 0.0F, false));
		
		LeftArm = new ModelRenderer(this);
		LeftArm.setRotationPoint(5.0F, -22.0F, 0.0F);
		villager.addChild(LeftArm);
		LeftArm.cubeList.add(new ModelBox(LeftArm, 0, 22, -1.0F, -2.0F, -2.0F, 5, 12, 4, 0.0F, false));
		
		RightLeg = new ModelRenderer(this);
		RightLeg.setRotationPoint(-1.9F, -12.0F, 0.0F);
		villager.addChild(RightLeg);
		RightLeg.cubeList.add(new ModelBox(RightLeg, 30, 21, -3.1F, 0.0F, -2.0F, 5, 12, 4, 0.0F, true));
		
		LeftLeg = new ModelRenderer(this);
		LeftLeg.setRotationPoint(1.9F, -12.0F, 0.0F);
		villager.addChild(LeftLeg);
		LeftLeg.cubeList.add(new ModelBox(LeftLeg, 30, 20, -2.0F, 0.0F, -2.0F, 5, 12, 4, 0.0F, false));
	}
