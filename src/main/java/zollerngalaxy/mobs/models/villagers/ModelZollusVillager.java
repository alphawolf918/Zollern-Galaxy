...
public class ModelZollusVillager extends ModelBase {
	...
	public ModelZollusVillager() {
		...
		Head.setRotationPoint(5.0F, -24.0F, 0.0F);
		villager.addChild(Head);
		Head.cubeList.add(new ModelBox(Head, 0, 0, -4.0F, -10.0F, -4.0F, 8, 10, 8, 0.0F, false));
		
		Head2 = new ModelRenderer(this);
		Head2.setRotationPoint(2.0F, -24.0F, 0.0F);
		villager.addChild(Head2);
		Head2.cubeList.add(new ModelBox(Head2, 0, 0, -11.0F, -10.0F, -4.0F, 8, 10, 8, 0.0F, false));
		...
		RightArm_r1.setRotationPoint(5.0F, 22.0F, -4.0F);
		RightArm.addChild(RightArm_r1);
		setRotationAngle(RightArm_r1, -0.1745F, 0.0F, 0.0F);
		RightArm_r1.cubeList.add(new ModelBox(RightArm_r1, 0, 22, -8.0F, -24.0F, -2.0F, 4, 12, 4, 0.0F, false));
		...
		LeftArm_r1.setRotationPoint(-5.0F, 22.0F, -4.0F);
		LeftArm.addChild(LeftArm_r1);
		setRotationAngle(LeftArm_r1, -0.1745F, 0.0F, 0.0F);
		LeftArm_r1.cubeList.add(new ModelBox(LeftArm_r1, 1, 22, 4.0F, -24.0F, -2.0F, 4, 12, 4, 0.0F, false));
		
		RightLeg = new ModelRenderer(this);
		RightLeg.setRotationPoint(-1.9F, -12.0F, 0.0F);
		villager.addChild(RightLeg);
		RightLeg.cubeList.add(new ModelBox(RightLeg, 20, 47, -2.1F, 0.0F, -2.0F, 4, 12, 4, 0.0F, true));
		
		LeftLeg = new ModelRenderer(this);
		LeftLeg.setRotationPoint(1.9F, -12.0F, 0.0F);
		villager.addChild(LeftLeg);
		LeftLeg.cubeList.add(new ModelBox(LeftLeg, 17, 44, -2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F, false));
	}
