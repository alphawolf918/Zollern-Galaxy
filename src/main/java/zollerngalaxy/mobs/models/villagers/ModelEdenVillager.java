...
public class ModelEdenVillager extends ModelBase {
	...
	public ModelEdenVillager() {
		...
		Head.cubeList.add(new ModelBox(Head, 0, 0, 0.0F, -21.0F, -4.0F, 8, 10, 8, 0.0F, false));
		Head.cubeList.add(new ModelBox(Head, 0, 0, -8.0F, -21.0F, -4.0F, 8, 10, 8, 0.0F, false));
		
		Body = new ModelRenderer(this);
		Body.setRotationPoint(0.0F, -24.0F, 0.0F);
		villager.addChild(Body);
		Body.cubeList.add(new ModelBox(Body, 40, 0, -4.0F, -10.75F, -2.0F, 8, 16, 4, 0.0F, false));
		...
		RightArm_r1_r1.setRotationPoint(0.0F, -4.0F, 0.0F);
		RightArm_r1.addChild(RightArm_r1_r1);
		setRotationAngle(RightArm_r1_r1, 0.0005F, 0.0308F, 0.0309F);
		RightArm_r1_r1.cubeList.add(new ModelBox(RightArm_r1_r1, 32, 1, -8.0F, -7.0711F, -9.0711F, 4, 20, 4, 0.0F, false));
		...
		LeftArm_r1_r1.setRotationPoint(0.0F, -4.0F, 0.0F);
		LeftArm_r1.addChild(LeftArm_r1_r1);
		setRotationAngle(LeftArm_r1_r1, 0.0005F, 0.0346F, 0.0266F);
		LeftArm_r1_r1.cubeList.add(new ModelBox(LeftArm_r1_r1, 32, 5, 4.0F, -7.9335F, -8.0876F, 4, 20, 4, 0.0F, false));
		...
		RightLeg_r1.setRotationPoint(1.9F, 12.0F, 1.0F);
		RightLeg.addChild(RightLeg_r1);
		setRotationAngle(RightLeg_r1, 0.0F, 0.0F, 0.0F);
		RightLeg_r1.cubeList.add(new ModelBox(RightLeg_r1, 34, 2, -4.0F, -19.0F, -3.0F, 3, 19, 4, 0.0F, true));
		...
		LeftLeg_r1.setRotationPoint(-1.9F, 12.0F, 1.0F);
		LeftLeg.addChild(LeftLeg_r1);
		setRotationAngle(LeftLeg_r1, 0.0F, 0.0F, 0.0F);
		LeftLeg_r1.cubeList.add(new ModelBox(LeftLeg_r1, 34, 2, 0.9F, -19.0F, -3.0F, 3, 19, 4, 0.0F, false));
	}
