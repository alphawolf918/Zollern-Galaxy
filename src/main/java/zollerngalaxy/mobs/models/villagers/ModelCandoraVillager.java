...
public class ModelCandoraVillager extends ModelBase {
	...
	public ModelCandoraVillager() {
		...
		Head.cubeList.add(new ModelBox(Head, 24, 0, -1.0F, -3.0F, -6.0F, 2, 3, 2, 0.0F, false));
		
		Body = new ModelRenderer(this);
		Body.setRotationPoint(0.0F, -24.0F, 0.0F);
		villager.addChild(Body);
		Body.cubeList.add(new ModelBox(Body, 20, 18, -4.0F, 0.25F, -2.0F, 8, 12, 4, 0.0F, false));
		...
		LeftLeg.cubeList.add(new ModelBox(LeftLeg, 20, 47, -2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F, false));
	}
