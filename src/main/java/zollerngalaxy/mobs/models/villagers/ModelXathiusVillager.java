...
public class ModelXathiusVillager extends ModelBase {
	...
	public ModelXathiusVillager() {
		...
		Head.cubeList.add(new ModelBox(Head, 0, 2, -4.0F, -8.0F, -4.0F, 8, 8, 8, 0.0F, false));
		
		HeadPiece = new ModelRenderer(this);
		HeadPiece.setRotationPoint(0.0F, -5.0F, 0.0F);
		Head.addChild(HeadPiece);
		setRotationAngle(HeadPiece, -0.5672F, 0.0F, 0.0F);
		HeadPiece.cubeList.add(new ModelBox(HeadPiece, 28, 54, -5.0F, -6.0F, -3.0F, 10, 8, 6, 0.0F, false));
		HeadPiece.cubeList.add(new ModelBox(HeadPiece, 34, 54, -4.0F, -9.0F, -2.0F, 8, 8, 4, 0.0F, false));
		HeadPiece.cubeList.add(new ModelBox(HeadPiece, 34, 54, -3.0F, -12.0F, -1.0F, 6, 7, 2, 0.0F, false));
		...
		RightArm.cubeList.add(new ModelBox(RightArm, 36, 48, -3.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F, false));
		RightArm.cubeList.add(new ModelBox(RightArm, 31, 25, -4.0F, -4.0F, -3.0F, 3, 6, 6, 0.0F, false));
		
		LeftArm = new ModelRenderer(this);
		LeftArm.setRotationPoint(5.0F, -22.0F, 0.0F);
		villager.addChild(LeftArm);
		LeftArm.cubeList.add(new ModelBox(LeftArm, 35, 48, -1.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F, false));
		LeftArm.cubeList.add(new ModelBox(LeftArm, 30, 22, 1.0F, -4.0F, -3.0F, 3, 6, 6, 0.0F, false));
		
		RightLeg = new ModelRenderer(this);
		RightLeg.setRotationPoint(-1.9F, -12.0F, 0.0F);
		villager.addChild(RightLeg);
		RightLeg.cubeList.add(new ModelBox(RightLeg, 12, 48, -2.1F, 0.0F, -2.0F, 4, 12, 4, 0.0F, true));
		
		LeftLeg = new ModelRenderer(this);
		LeftLeg.setRotationPoint(1.9F, -12.0F, 0.0F);
		villager.addChild(LeftLeg);
		LeftLeg.cubeList.add(new ModelBox(LeftLeg, 12, 48, -2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F, false));
	}
