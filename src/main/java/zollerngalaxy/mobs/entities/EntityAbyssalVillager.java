...
public class EntityAbyssalVillager extends EntityAgeable implements IMerchant, INpc, IEntityBreathable {
	...
	private void populateBuyingList() {
		...
		for (EntityAbyssalVillager.ITradeList tradeList : DEFAULT_TRADE_LIST_MAP) {
	...
	@Override
	public EntityAbyssalVillager createChild(EntityAgeable ageable) {
		EntityAbyssalVillager entityvillager = new EntityAbyssalVillager(this.world);
	...
	public static class EmeraldForItems implements EntityAbyssalVillager.ITradeList {
		public ItemStack sellItem;
		public EntityAbyssalVillager.PriceInfo price;
		
		public EmeraldForItems(ItemStack itemStack, EntityAbyssalVillager.PriceInfo priceIn) {
	...
	public static class ItemAndEmeraldToItem implements EntityAbyssalVillager.ITradeList {
		public ItemStack field_179411_a;
		public EntityAbyssalVillager.PriceInfo field_179409_b;
		public ItemStack field_179410_c;
		
		public ItemAndEmeraldToItem(Item p_i45813_1_, EntityAbyssalVillager.PriceInfo p_i45813_2_, Item p_i45813_3_) {
		...
		public ItemAndEmeraldToItem(ItemStack p_i45813_1_, EntityAbyssalVillager.PriceInfo p_i45813_2_, ItemStack p_i45813_3_) {
	...
	public static class ListItemForEmeralds implements EntityAbyssalVillager.ITradeList {
		public ItemStack itemToBuy;
		public EntityAbyssalVillager.PriceInfo priceInfo;
		
		public ListItemForEmeralds(ItemStack stack, EntityAbyssalVillager.PriceInfo priceInfo) {
