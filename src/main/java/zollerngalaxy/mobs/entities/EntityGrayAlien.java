...
public class EntityGrayAlien extends EntityMob implements IEntityBreathable {
	...
	public EntityGrayAlien(World worldIn) {
		...
		this.tasks.addTask(5, new EntityAIWatchClosest2(this, EntityGrayAlien.class, 5.0F, 0.02F));
		this.tasks.addTask(5, new EntityAIWatchClosest2(this, EntityMummy.class, 5.0F, 0.02F));
		this.tasks.addTask(5, new EntityAIWander(this, 5.6D));
