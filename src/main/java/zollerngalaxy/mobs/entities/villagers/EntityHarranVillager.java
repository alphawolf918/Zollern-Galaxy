...
public class EntityHarranVillager extends EntityZGVillagerBase {
	...
	public EntityHarranVillager(World worldIn) {
		...
		this.setPriceItem(new ItemStack(ZGItems.opal, ZGHelper.rngInt(2, 4)));
	}
	...
	protected ITradeList[] getTradeList() {
		ITradeList[] TRADE_LIST = new ITradeList[] { new ListVillagerItems(new ItemStack(ZGItems.alienStone, 1), new PriceInfo(1, 2)),
				new ListVillagerItems(new ItemStack(ZGItems.amber, 2), new PriceInfo(1, 2)),
				new ListVillagerItems(new ItemStack(ZGItems.aquamarine, 4), new PriceInfo(1, 2)),
