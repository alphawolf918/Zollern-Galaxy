...
public class EntityCaligroVillager extends EntityZGVillagerBase {
	...
	public EntityCaligroVillager(World worldIn) {
		...
		this.setPriceItem(new ItemStack(ZGItems.darkEssence, ZGHelper.rngInt(1, 4)));
	}
	...
	protected ITradeList[] getTradeList() {
		ITradeList[] TRADE_LIST = new ITradeList[] { new ListVillagerItems(new ItemStack(ZGItems.shadowBone, 1), new PriceInfo(1, 2)),
				new ListVillagerItems(new ItemStack(ZGItems.swordZollernium, 1), new PriceInfo(3, 4)),
				new ListVillagerItems(new ItemStack(ZGItems.oxygenTankTier4, 1), new PriceInfo(3, 4)),
