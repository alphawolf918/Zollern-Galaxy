...
public class EntityAbyssalVillager extends EntityZGVillagerBase {
	...
	public EntityAbyssalVillager(World worldIn) {
		...
		this.setPriceItem(new ItemStack(ZGItems.ingotRhodium, ZGHelper.rngInt(1, 4)));
	}
	...
	protected ITradeList[] getTradeList() {
		ITradeList[] TRADE_LIST = new ITradeList[] { new ListVillagerItems(new ItemStack(ZGItems.compressedRhodium, 1), new PriceInfo(1, 2)),
				new ListVillagerItems(new ItemStack(ZGItems.dustRhodium, 2), new PriceInfo(1, 2)),
				new ListVillagerItems(new ItemStack(ZGItems.healingHeartForce, 1), new PriceInfo(1, 2)),
