...
public abstract class EntityAIBugTarget extends EntityAIBase {
	...
	/**
	 * When nearbyOnly is true: 0 -> No target, but OK to search; 1 -> Nearby target found; 2 ->
	 * Target too far.
	 */
	...
	/**
	 * If @shouldCheckSight is true, the number of ticks before the interuption of this AITastk when
	 * the entity does't
	 * see the target
	 */
	...
	/**
	 * A method used to see if an entity is a suitable target through a number of checks. Args :
	 * entity,
