...
public class EntityAIFindNearestPlayerZG extends EntityAIBase {
	
	private static final Logger LOGGER = LogManager.getLogger();
	private final EntityLiving entityLiving;
	private final Predicate<Entity> predicate;
	private final EntityAIFindNearestPlayerZG.Sorter sorter;
	private EntityLivingBase entityTarget;
	
	public EntityAIFindNearestPlayerZG(EntityLiving entityLivingIn) {
		...
		this.predicate = new Predicate<Entity>() {
			...
			public boolean apply(@Nullable Entity entityIn) {
				if (!(entityIn instanceof EntityPlayer)) {
					...
					double d0 = EntityAIFindNearestPlayerZG.this.maxTargetRange();
					...
					return entityIn.getDistance(EntityAIFindNearestPlayerZG.this.entityLiving) > d0 ? false : EntityAITarget.isSuitableTarget(EntityAIFindNearestPlayerZG.this.entityLiving, (EntityLivingBase) entityIn, false, true);
				}
			}
		};
		this.sorter = new EntityAIFindNearestPlayerZG.Sorter(entityLivingIn);
	}
