...
public enum EnumOreGenZG {
	...
	COAL(17, 20, 0, 128), IRON(9, 20, 0, 64), GOLD(9, 2, 0, 32), REDSTONE(8, 8,
			0, 16), LAPIS(7, 1, 16, 16), // lapis genCount, blockCount,
											// centerHeight, spread
	DIAMOND(8, 1, 0, 16), DIRT(33, 10, 0, 256), GRAVEL(33, 8, 0, 256), SILICON(
