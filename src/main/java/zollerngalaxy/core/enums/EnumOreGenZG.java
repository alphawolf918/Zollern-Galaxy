...
public enum EnumOreGenZG {
	...
	COAL(17, 20, 0, 128), IRON(11, 20, 0, 64), GOLD(16, 6, 0, 32), REDSTONE(8, 8, 0, 16), LAPIS(7,
			...
			2, 10, 0, 256), PACKED_ICE(53, 20, 0, 256), MAGMA(53, 35, 0, 256), GRAVEL(33, 8, 0, 256), SILICON(
			7, 3, 0, 25), ALUMINUM(7, 18, 0, 45), TIN(7, 22, 0, 60), COPPER(7, 24, 0, 75), LEAD(4,
			12, 0, 36), COBALT(5, 14, 0, 24);
