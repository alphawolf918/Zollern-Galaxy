...
public class WorldProviderOrbitPerdita extends WorldProviderOverworldOrbit {
	
	@Override
	public CelestialBody getCelestialBody() {
		return ZGSpaceStations.PERDITA_SPACE_STATION;
	}
	...
	public String getPlanetToOrbit() {
		return "planet.perdita";
	}
	
	@Override
	public String getSaveFolder() {
		return ZGInfo.SPACE_STATION_PFX + "/perdita";
	}
	...
	public boolean canSpaceshipTierPass(int tier) {
		return tier >= ZGPlanets.planetPerdita.getTierRequirement();
	}
	...
	public DimensionType getDimensionType() {
		return ZGDimensions.PERDITA_ORBIT;
	}
	
	@Override
	public int getPlanetIdToOrbit() {
		return ConfigManagerZG.planetPerditaDimensionId;
	}
}