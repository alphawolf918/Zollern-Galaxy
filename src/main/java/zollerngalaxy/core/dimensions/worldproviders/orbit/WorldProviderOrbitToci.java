...
public class WorldProviderOrbitToci extends WorldProviderOverworldOrbit {
	
	@Override
	public CelestialBody getCelestialBody() {
		return ZGSpaceStations.TOCI_SPACE_STATION;
	}
	...
	public String getSaveFolder() {
		return ZGInfo.SPACE_STATION_PFX + "/toci";
	}
	...
	public boolean canSpaceshipTierPass(int tier) {
		return tier > ZGPlanets.planetToci.getTierRequirement();
	}
	...
	public DimensionType getDimensionType() {
		return ZGDimensions.TOCI_ORBIT;
	}
	
	@Override
	public int getPlanetIdToOrbit() {
		return ConfigManagerZG.planetTociDimensionId;
	}
}