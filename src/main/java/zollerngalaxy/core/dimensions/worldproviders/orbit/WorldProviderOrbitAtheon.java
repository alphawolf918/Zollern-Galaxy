...
public class WorldProviderOrbitAtheon extends WorldProviderOverworldOrbit {
	
	@Override
	public CelestialBody getCelestialBody() {
		return ZGSpaceStations.ATHEON_SPACE_STATION;
	}
	...
	public String getPlanetToOrbit() {
		return "planet.atheon";
	}
	
	@Override
	public String getSaveFolder() {
		return ZGInfo.SPACE_STATION_PFX + "/atheon";
	}
	...
	public boolean canSpaceshipTierPass(int tier) {
		return tier > ZGPlanets.planetAtheon.getTierRequirement();
	}
	...
	public DimensionType getDimensionType() {
		return ZGDimensions.ATHEON_ORBIT;
	}
	
	@Override
	public int getPlanetIdToOrbit() {
		return ConfigManagerZG.planetAtheonDimensionId;
	}
}