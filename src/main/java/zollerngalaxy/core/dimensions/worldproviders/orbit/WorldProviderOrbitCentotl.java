...
public class WorldProviderOrbitCentotl extends WorldProviderOverworldOrbit {
	
	@Override
	public CelestialBody getCelestialBody() {
		return ZGSpaceStations.CENTOTL_SPACE_STATION;
	}
	...
	public String getPlanetToOrbit() {
		return "planet.centotl";
	}
	
	@Override
	public String getSaveFolder() {
		return ZGInfo.SPACE_STATION_PFX + "/centotl";
	}
	...
	public boolean canSpaceshipTierPass(int tier) {
		return tier > ZGPlanets.planetCentotl.getTierRequirement();
	}
	...
	public DimensionType getDimensionType() {
		return ZGDimensions.CENTOTL_ORBIT;
	}
	
	@Override
	public int getPlanetIdToOrbit() {
		return ConfigManagerZG.planetCentotlDimensionId;
	}
}