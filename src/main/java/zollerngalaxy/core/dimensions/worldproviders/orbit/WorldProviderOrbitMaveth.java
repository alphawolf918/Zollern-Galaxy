...
public class WorldProviderOrbitMaveth extends WorldProviderOverworldOrbit {
	
	@Override
	public CelestialBody getCelestialBody() {
		return ZGSpaceStations.MAVETH_SPACE_STATION;
	}
	...
	public String getPlanetToOrbit() {
		return "planet.maveth";
	}
	
	@Override
	public String getSaveFolder() {
		return ZGInfo.SPACE_STATION_PFX + "/maveth";
	}
	...
	public boolean canSpaceshipTierPass(int tier) {
		return tier > ZGPlanets.planetMaveth.getTierRequirement();
	}
	...
	public DimensionType getDimensionType() {
		return ZGDimensions.MAVETH_ORBIT;
	}
	
	@Override
	public int getPlanetIdToOrbit() {
		return ConfigManagerZG.planetMavethDimensionId;
	}
}