...
public class WorldProviderOrbitAltum extends WorldProviderOverworldOrbit {
	...
	public CelestialBody getCelestialBody() {
		return ZGSpaceStations.ALTUM_SPACE_STATION;
	}
	...
	public boolean canSpaceshipTierPass(int tier) {
		return tier >= ZGPlanets.planetAltum.getTierRequirement();
	}
	...
	public DimensionType getDimensionType() {
		return ZGDimensions.ALTUM_ORBIT;
	}
	
	@Override
	public int getPlanetIdToOrbit() {
		return ConfigManagerZG.planetAltumDimensionId;
	}
}