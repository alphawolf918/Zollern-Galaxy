...
public class WorldProviderExodus extends WorldProviderPlanetZG {
	...
	protected void renderSky() {
		this.setSkyRenderer(new SkyProviderExodus(this));
	}
	...
	public Class<? extends BiomeProvider> getBiomeProviderClass() {
		BiomeAdaptive.setBodyMultiBiome(ZGPlanets.planetExodus);
		return BiomeProviderExodus.class;
	}
	
	@Override
	public Class<? extends IChunkGenerator> getChunkProviderClass() {
		return ChunkProviderExodus.class;
	}
}