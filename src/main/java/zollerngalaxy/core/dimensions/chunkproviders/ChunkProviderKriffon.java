...
public class ChunkProviderKriffon extends ChunkProviderBase {
	...
	private final BiomeDecoratorKriffon biomeDecoratorKriffon = new BiomeDecoratorKriffon();
	private Random rand;
	...
	public ChunkProviderKriffon(World worldIn, long seed, boolean mapFeaturesEnabled) {
		this.world = worldIn;
