...
public class ChunkProviderTlaloc extends ChunkProviderBase {
	...
	public static final IBlockState STONE = ZGBlocks.tlalocStone.getDefaultState();
	public static final IBlockState AIR = Blocks.AIR.getDefaultState();
	public static IBlockState WHITE_LAVA = ZGFluids.blockWhiteLavaFluid.getDefaultState();
	
	public static final double CHUNK_HEIGHT = 43.0D;
	public static final int SEA_LEVEL = 33;
	
	private static final int CHUNK_SIZE_X = 16;
	private static final int CHUNK_SIZE_Z = 16;
	
	private final BiomeDecoratorTlaloc biomeDecoratorTlaloc = new BiomeDecoratorTlaloc();
	private Random rand;
	...
	private MapGenCavesZG caveGenerator2 = new MapGenCavesZG(STONE.getBlock(), WHITE_LAVA.getBlock());
	...
	private final MapGenVillageZG villageGenerator = new MapGenVillageZG("Tlaloc", ZGBlocks.tlalocMechRock);
						...
						for (int k2 = 0; k2 < 4; ++k2) {
							...
							for (int l2 = 0; l2 < 4; ++l2) {
								...
								if ((lvt_45_1_ += d16) > this.noiseGenSmooth1.getNoise(chunkX * 16 + x, chunkZ * 16 + z) * chunkHeight) {
									...
									IBlockState blockToUse = WHITE_LAVA;
