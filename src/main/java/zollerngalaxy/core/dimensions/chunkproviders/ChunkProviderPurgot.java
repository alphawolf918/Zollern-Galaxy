...
public class ChunkProviderPurgot extends ChunkProviderBase {
	...
	public static final IBlockState BLOCK_TOP = ZGBlocks.purgSurfaceRock.getDefaultState();
	public static final IBlockState BLOCK_FILL = ZGBlocks.purgDirt.getDefaultState();
	public static final IBlockState BLOCK_LOWER = ZGBlocks.purgStone.getDefaultState();
	...
	private Biome[] biomesForGeneration = { ZGBiomes.PURGOT };
