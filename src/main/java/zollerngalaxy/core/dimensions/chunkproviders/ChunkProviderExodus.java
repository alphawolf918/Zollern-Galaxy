...
public class ChunkProviderExodus extends ChunkProviderBase {
	...
	public static final int SEA_LEVEL = 43;
	
	private static final int CHUNK_SIZE_X = 16;
	private static final int CHUNK_SIZE_Z = 16;
	
	private final BiomeDecoratorExodus biomeDecoratorExodus = new BiomeDecoratorExodus();
	private Random rand;
	...
	private MapGenCavesZG caveGenerator = new MapGenCavesZG(ZGBlocks.exodusStone);
	private final MapGenRavinesZG ravineGenerator = new MapGenRavinesZG(ZGBlocks.exodusStone);
	private final MapGenVillageZG villageGenerator = new MapGenVillageZG("Exodus", ZGBlocks.exoWoodPlanks);
			...
			for (int cz = chunkZ - 2; cz <= chunkZ + 2; cz++) {
				for (int x = 0; x < ChunkProviderExodus.CHUNK_SIZE_X; x++) {
					for (int z = 0; z < ChunkProviderExodus.CHUNK_SIZE_Z; z++) {
						if (Math.abs(this.randFromPoint(cx * 16 + x, (cz * 16 + z) * 1000)) < this.noiseGen4.getValue(x * ChunkProviderExodus.CHUNK_SIZE_X + x, cz * ChunkProviderExodus.CHUNK_SIZE_Z + z) / ChunkProviderExodus.CRATER_PROB) {
