...
public class ChunkProviderXathius extends ChunkProviderBase {
	
	public static final IBlockState STONE = ZGBlocks.xathStone.getDefaultState();
	public static final IBlockState WATER = Blocks.WATER.getDefaultState();
	
	public static final double CHUNK_HEIGHT = 35.0D;
	public static final int SEA_LEVEL = 63;
	
	private static final int CHUNK_SIZE_X = 16;
	private static final int CHUNK_SIZE_Z = 16;
	
	private final BiomeDecoratorXathius biomeDecoratorXathius = new BiomeDecoratorXathius();
	private Random rand;
	...
	private final MapGenVillageZG villageGenerator = new MapGenVillageZG("Xathius", ZGBlocks.xathRockBricks);
	...
	public ChunkProviderXathius(World worldIn, long seed, boolean mapFeaturesEnabled) {
		this.world = worldIn;
			...
			for (int cz = chunkZ - 2; cz <= chunkZ + 2; cz++) {
				for (int x = 0; x < ChunkProviderXathius.CHUNK_SIZE_X; x++) {
					for (int z = 0; z < ChunkProviderXathius.CHUNK_SIZE_Z; z++) {
						if (Math.abs(this.randFromPoint(cx * 16 + x, (cz * 16 + z) * 1000)) < this.noiseGen4.getValue(x * ChunkProviderXathius.CHUNK_SIZE_X + x,
								cz * ChunkProviderXathius.CHUNK_SIZE_Z + z) / ChunkProviderXathius.CRATER_PROB) {
