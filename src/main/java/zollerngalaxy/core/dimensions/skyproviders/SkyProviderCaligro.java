...
public class SkyProviderCaligro extends IRenderHandler {
	
	private static ResourceLocation sol2Texture = new ResourceLocation("zollerngalaxy:textures/gui/sol2.png");
	...
	public SkyProviderCaligro(IGalacticraftWorldProvider worldProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderCaligro.sol2Texture);
