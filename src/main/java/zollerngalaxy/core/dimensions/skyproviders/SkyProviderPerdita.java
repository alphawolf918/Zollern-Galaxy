...
public class SkyProviderPerdita extends IRenderHandler {
	...
	public SkyProviderPerdita(IGalacticraftWorldProvider worldProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderPerdita.sol2Texture);
