...
public class SkyProviderMaveth extends IRenderHandler {
	
	private static ResourceLocation asgardTexture = new ResourceLocation("zollerngalaxy:textures/gui/asgard.png");
	private static ResourceLocation asgardStarTexture = new ResourceLocation("zollerngalaxy:textures/gui/asgard_star.png");
	...
	public SkyProviderMaveth(IGalacticraftWorldProvider worldProvider) {
		this.sunSize = 0.05F * worldProvider.getSolarSize();
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		GL11.glRotatef(-90.0F, 0.0F, 1.0F, 0.0F);
		GL11.glRotatef(world.getCelestialAngle(partialTicks) * 360.0F, 1.0F, 0.0F, 0.0F);
		afloat[0] = 128F / 255.0F;
		afloat[1] = 128F / 255.0F;
		afloat[2] = 128F / 255.0F;
		afloat[3] = 0.3F;
		f6 = afloat[0];
		f7 = afloat[1];
		f8 = afloat[2];
		...
		GL11.glEnable(GL11.GL_TEXTURE_2D);
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderMaveth.asgardStarTexture);
		...
		GL11.glRotatef(world.getCelestialAngle(partialTicks) * 90.0F, 1.0F, 0.0F, 0.0F);
		// GL11.glColor4f(1.0F, 1.0F, 1.0F, 0.0F);
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderMaveth.asgardTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
		...
		if (world.provider.isSkyColored()) {
			GL11.glColor3f(f1 * 0.6F + 0.06F, f2 * 0.6F + 0.04F, f3 * 0.6F + 0.06F);
		} else {
			GL11.glColor3f(f1, f2, f3);
		}
