...
public class SkyProviderToci extends IRenderHandler {
	
	private static ResourceLocation tlalocTexture = new ResourceLocation("zollerngalaxy:textures/gui/tlaloc.png");
	...
	public SkyProviderToci(IGalacticraftWorldProvider worldProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		GL11.glEnable(GL11.GL_TEXTURE_2D);
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderToci.pantheonTexture);
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderToci.tlalocTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
