...
public class SkyProviderCandora extends IRenderHandler {
	
	private static ResourceLocation oasisTexture = new ResourceLocation("zollerngalaxy:textures/gui/oasis.png");
	private static ResourceLocation praedythTexture = new ResourceLocation("zollerngalaxy:textures/gui/praedyth.png");
	...
	public SkyProviderCandora(IGalacticraftWorldProvider worldProvider) {
		this.sunSize = 5.7F * worldProvider.getSolarSize();
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderCandora.praedythTexture);
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderCandora.oasisTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
	...
	private Vec3d getCustomSkyColor() {
		return new Vec3d(80.0D, 0.0D, 80.0D);
	}
