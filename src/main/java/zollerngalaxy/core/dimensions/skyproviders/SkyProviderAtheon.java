...
public class SkyProviderAtheon extends IRenderHandler {
	...
	public SkyProviderAtheon(IGalacticraftWorldProvider worldProvider) {
		this.sunSize = 7.7F * worldProvider.getSolarSize();
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderAtheon.praedythTexture);
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderAtheon.oasisTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
