...
public class SkyProviderKronos extends IRenderHandler {
	
	private static ResourceLocation olympusTexture = new ResourceLocation("zollerngalaxy:textures/gui/olympus.png");
	...
	public SkyProviderKronos(IGalacticraftWorldProvider worldProvider) {
		this.sunSize = 0.2F * worldProvider.getSolarSize();
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderKronos.olympusTexture);
