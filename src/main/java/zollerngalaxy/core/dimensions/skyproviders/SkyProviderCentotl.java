...
public class SkyProviderCentotl extends IRenderHandler {
	
	private static ResourceLocation metztliTexture = new ResourceLocation("zollerngalaxy:textures/gui/metztli.png");
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderCentotl.pantheonTexture);
