...
public class SkyProviderXathius extends IRenderHandler {
	...
	public SkyProviderXathius(IGalacticraftWorldProvider worldProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderXathius.praedythTexture);
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderXathius.oasisTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
