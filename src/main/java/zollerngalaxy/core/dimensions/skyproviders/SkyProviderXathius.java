...
public class SkyProviderXathius extends IRenderHandler {
	...
	private static ResourceLocation oasisTexture = new ResourceLocation(
			"zollerngalaxy:textures/gui/oasis.png");
	private static ResourceLocation praedythTexture = new ResourceLocation(
			"zollerngalaxy:textures/gui/praedyth.png");
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		FMLClientHandler.instance().getClient().renderEngine
				.bindTexture(SkyProviderXathius.oasisTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
