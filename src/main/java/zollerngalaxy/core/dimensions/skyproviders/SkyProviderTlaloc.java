...
public class SkyProviderTlaloc extends IRenderHandler {
	
	private static ResourceLocation tociTexture = new ResourceLocation("zollerngalaxy:textures/gui/toci.png");
	private static ResourceLocation pantheonTexture = new ResourceLocation("zollerngalaxy:textures/gui/pantheon.png");
	...
	public SkyProviderTlaloc(IGalacticraftWorldProvider worldProvider) {
		this.sunSize = 8.5F * worldProvider.getSolarSize();
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		GL11.glEnable(GL11.GL_TEXTURE_2D);
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderTlaloc.pantheonTexture);
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderTlaloc.tociTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
