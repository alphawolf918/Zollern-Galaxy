...
public class SkyProviderExodus extends IRenderHandler {
	...
	public SkyProviderExodus(IGalacticraftWorldProvider worldProvider) {
		this.sunSize = 5.2F * worldProvider.getSolarSize();
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderExodus.sol2Texture);
