...
public class SkyProviderAstros extends IRenderHandler {
	
	private static ResourceLocation edenTexture = new ResourceLocation("zollerngalaxy:textures/gui/eden.png");
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderAstros.psios6Texture);
		...
		if (world.provider.isSkyColored()) {
			GL11.glColor3f(f1 * 0.1F + 0.01F, f2 * 0.2F + 0.01F, f3 * 2.6F + 0.1F);
		} else {
			GL11.glColor3f(f1, f2, f3);
		}
