...
public class SkyProviderAltum extends IRenderHandler {
	...
	public SkyProviderAltum(IGalacticraftWorldProvider worldProvider) {
		this.sunSize = 6.2F * worldProvider.getSolarSize();
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderAltum.sol2Texture);
