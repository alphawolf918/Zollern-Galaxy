...
public class SkyProviderOasis extends IRenderHandler {
	...
	private static ResourceLocation xathiusTexture = new ResourceLocation("zollerngalaxy:textures/gui/xathius.png");
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderOasis.praedythTexture);
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderOasis.xathiusTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
		...
		if (world.provider.isSkyColored()) {
			GL11.glColor3f(f1 * 1.2F + 0.05F, f2 * 0.2F + 0.04F, f3 * 0.6F + 0.1F);
		} else {
			GL11.glColor3f(f1, f2, f3);
		}
