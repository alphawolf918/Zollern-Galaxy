...
public class SkyProviderMetztli extends IRenderHandler {
	
	private static ResourceLocation vortexTexture = new ResourceLocation("zollerngalaxy:textures/gui/vortex.png");
	...
	public SkyProviderMetztli(IGalacticraftWorldProvider worldProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderMetztli.pantheonTexture);
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(SkyProviderMetztli.vortexTexture);
		worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
		...
		if (world.provider.isSkyColored()) {
			GL11.glColor3f(f1 * 0.2F + 0.06F, f2 * 0.6F + 0.04F, f3 * 0.2F + 0.1F);
		} else {
			GL11.glColor3f(f1, f2, f3);
		}
	...
	private Vec3d getCustomSkyColor() {
		return new Vec3d(80.0D, 70.0D, 0.0D);
	}
