...
public class ZGBlockTreasureChest extends BlockContainer implements ITileEntityProvider, IShiftDescription, ISortableBlock, ISingleZGBlockRender {
			...
			if (block != this && block1 != this) {
				...
				if (block2 == this || block3 == this) {
					...
					if (block2 == this) {
						...
						enumfacing2 = iblockstate4.getValue(FACING);
					}
				...
				if (block == this) {
					...
					enumfacing1 = iblockstate2.getValue(FACING);
				}
	...
	private boolean isOcelotSittingOnChest(World worldIn, BlockPos pos) {
		Iterator iterator = worldIn.getEntitiesWithinAABB(EntityOcelot.class, new AxisAlignedBB(pos.getX(), pos.getY() + 1, pos.getZ(), pos.getX() + 1, pos.getY() + 2, pos.getZ() + 1)).iterator();
	...
	public String getShiftDescription(int meta) {
		return ZGUtils.translate("tooltips.chest_t1.description");
	}
