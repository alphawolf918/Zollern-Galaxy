 ...
 * redistribute it.
 */
package zollerngalaxy.biomes.genlayers.kriffon;

import net.minecraft.world.gen.layer.GenLayer;
import net.minecraft.world.gen.layer.GenLayerVoronoiZoom;
import net.minecraft.world.gen.layer.GenLayerZoom;

public abstract class GenLayerKriffon extends GenLayer {
	
	public GenLayerKriffon(long l) {
		super(l);
	}
	
	public static GenLayer[] createWorld(long l) {
		GenLayer biomes = new GenLayerKriffonBiomes(l);
