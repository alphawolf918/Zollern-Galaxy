 ...
 * redistribute it.
 */
package zollerngalaxy.biomes.genlayers.candora;

import net.minecraft.world.gen.layer.GenLayer;
import net.minecraft.world.gen.layer.GenLayerVoronoiZoom;
import net.minecraft.world.gen.layer.GenLayerZoom;

public abstract class GenLayerCandora extends GenLayer {
	
	public GenLayerCandora(long l) {
		super(l);
	}
	
	public static GenLayer[] createWorld(long l) {
		GenLayer biomes = new GenLayerCandoraBiomes(l);
