...
public class GenLayerTociBiomes extends GenLayerToci {
	...
	private ArrayList<BiomeEntry>[] setupBiomes() {
		...
		list.add(new BiomeEntry(ZGBiomes.TOCI_BASE, 100));
		list.add(new BiomeEntry(ZGBiomes.TOCI_DESERT, 90));
		list.add(new BiomeEntry(ZGBiomes.TOCI_STAR_DESERT, 80));
		list.add(new BiomeEntry(ZGBiomes.TOCI_VALLEY, 70));
		list.add(new BiomeEntry(ZGBiomes.TOCI_MOUNTAINS, 60));
