 ...
 * redistribute it.
 */
package zollerngalaxy.biomes.genlayers.zollus;

import net.minecraft.world.gen.layer.GenLayer;
import net.minecraft.world.gen.layer.GenLayerVoronoiZoom;
import net.minecraft.world.gen.layer.GenLayerZoom;

public abstract class GenLayerZollus extends GenLayer {
	
	public GenLayerZollus(long l) {
		super(l);
	}
	
	public static GenLayer[] createWorld(long l) {
		GenLayer biomes = new GenLayerZollusBiomes(l);
