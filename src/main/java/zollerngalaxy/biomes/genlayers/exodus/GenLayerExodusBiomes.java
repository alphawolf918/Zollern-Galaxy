 ...
 * redistribute it.
 */
package zollerngalaxy.biomes.genlayers.exodus;
...
public class GenLayerExodusBiomes extends GenLayerExodus {
	...
	public GenLayerExodusBiomes(long seed) {
		super(seed);
	...
	private ArrayList<BiomeEntry>[] setupBiomes() {
		...
		list.add(new BiomeEntry(ZGBiomes.EXODUS_CHROMA_GRASS_FIELDS, 90));
		...
		list.add(new BiomeEntry(ZGBiomes.EXODUS_BLACK_MESA, 70));
