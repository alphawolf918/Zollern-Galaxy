 ...
 * redistribute it.
 */
package zollerngalaxy.biomes.genlayers.oasis;
...
public class GenLayerOasisBiomes extends GenLayerOasis {
	...
	public GenLayerOasisBiomes(long seed) {
		super(seed);
	...
	private ArrayList<BiomeEntry>[] setupBiomes() {
		...
		list.add(new BiomeEntry(ZGBiomes.OASIS_PLAINS, 100));
		list.add(new BiomeEntry(ZGBiomes.OASIS_RED_OCEAN, 90));
