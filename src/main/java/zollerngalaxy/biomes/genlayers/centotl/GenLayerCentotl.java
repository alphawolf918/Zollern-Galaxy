 ...
 * redistribute it.
 */
package zollerngalaxy.biomes.genlayers.centotl;

import net.minecraft.world.gen.layer.GenLayer;
import net.minecraft.world.gen.layer.GenLayerVoronoiZoom;
import net.minecraft.world.gen.layer.GenLayerZoom;

public abstract class GenLayerCentotl extends GenLayer {
	
	public GenLayerCentotl(long l) {
		super(l);
	}
	
	public static GenLayer[] createWorld(long l) {
		GenLayer biomes = new GenLayerCentotlBiomes(l);
