 ...
 * redistribute it.
 */
package zollerngalaxy.biomes.genlayers.astros;
...
public class GenLayerAstrosBiomes extends GenLayerAstros {
	...
	public GenLayerAstrosBiomes(long seed) {
		super(seed);
	...
	private ArrayList<BiomeEntry>[] setupBiomes() {
		...
		list.add(new BiomeEntry(ZGBiomes.ASTROS_GLACIERS, 80));
