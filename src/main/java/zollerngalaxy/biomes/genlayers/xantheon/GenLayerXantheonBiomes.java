 ...
 * redistribute it.
 */
package zollerngalaxy.biomes.genlayers.xantheon;
...
public class GenLayerXantheonBiomes extends GenLayerXantheon {
	...
	public GenLayerXantheonBiomes(long seed) {
		super(seed);
	...
	private ArrayList<BiomeEntry>[] setupBiomes() {
		...
		list.add(new BiomeEntry(ZGBiomes.XANTHEON, 100));
