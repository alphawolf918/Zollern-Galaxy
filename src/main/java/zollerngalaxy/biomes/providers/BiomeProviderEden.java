...
public class BiomeProviderEden extends BiomeProvider {
	...
	protected BiomeProviderEden() {
		body = ZGPlanets.planetEden;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderEden(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerEden.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderEden(World world) {
