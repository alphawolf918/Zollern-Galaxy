...
public class BiomeProviderZollus extends BiomeProvider {
	...
	protected BiomeProviderZollus() {
		body = ZGPlanets.planetZollus;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderZollus(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerZollus.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderZollus(World world) {
