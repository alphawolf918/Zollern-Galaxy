...
import zollerngalaxy.biomes.genlayers.candora.GenLayerCandora;
import zollerngalaxy.celestial.ZGPlanets;

public class BiomeProviderCandora extends BiomeProvider {
	...
	protected BiomeProviderCandora() {
		body = ZGPlanets.planetCandora;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderCandora(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerCandora.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderCandora(World world) {
