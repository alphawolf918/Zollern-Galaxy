...
public class BiomeProviderKriffon extends BiomeProvider {
	...
	protected BiomeProviderKriffon() {
		body = ZGPlanets.planetKriffon;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderKriffon(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerKriffon.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderKriffon(World world) {
