...
import zollerngalaxy.biomes.genlayers.maveth.GenLayerMaveth;
import zollerngalaxy.celestial.ZGPlanets;

public class BiomeProviderMaveth extends BiomeProvider {
	...
	protected BiomeProviderMaveth() {
		body = ZGPlanets.planetMaveth;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderMaveth(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerMaveth.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderMaveth(World world) {
