...
import zollerngalaxy.biomes.genlayers.oasis.GenLayerOasis;
import zollerngalaxy.planets.ZGPlanets;

public class BiomeProviderOasis extends BiomeProvider {
	...
	protected BiomeProviderOasis() {
		body = ZGPlanets.planetOasis;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderOasis(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerOasis.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderOasis(World world) {
