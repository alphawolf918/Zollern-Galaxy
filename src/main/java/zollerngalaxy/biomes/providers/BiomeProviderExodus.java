...
import zollerngalaxy.biomes.genlayers.exodus.GenLayerExodus;
import zollerngalaxy.planets.ZGPlanets;

public class BiomeProviderExodus extends BiomeProvider {
	...
	protected BiomeProviderExodus() {
		body = ZGPlanets.planetExodus;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderExodus(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerExodus.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderExodus(World world) {
