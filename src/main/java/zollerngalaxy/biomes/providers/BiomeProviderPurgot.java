...
public class BiomeProviderPurgot extends BiomeProvider {
	...
	protected BiomeProviderPurgot() {
		body = ZGPlanets.planetPurgot;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderPurgot(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerPurgot.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderPurgot(World world) {
