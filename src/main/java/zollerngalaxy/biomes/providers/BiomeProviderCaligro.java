...
import zollerngalaxy.biomes.genlayers.caligro.GenLayerCaligro;
import zollerngalaxy.celestial.ZGPlanets;

public class BiomeProviderCaligro extends BiomeProvider {
	...
	protected BiomeProviderCaligro() {
		body = ZGPlanets.planetCaligro;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderCaligro(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerCaligro.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderCaligro(World world) {
