...
import zollerngalaxy.biomes.genlayers.vortex.GenLayerVortex;
import zollerngalaxy.celestial.ZGPlanets;

public class BiomeProviderVortex extends BiomeProvider {
	...
	protected BiomeProviderVortex() {
		body = ZGPlanets.planetVortex;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderVortex(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerVortex.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderVortex(World world) {
