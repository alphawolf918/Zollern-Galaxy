...
import zollerngalaxy.biomes.genlayers.xathius.GenLayerXathius;
import zollerngalaxy.planets.ZGPlanets;

public class BiomeProviderXathius extends BiomeProvider {
	...
	protected BiomeProviderXathius() {
		body = ZGPlanets.planetXathius;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderXathius(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerXathius.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderXathius(World world) {
