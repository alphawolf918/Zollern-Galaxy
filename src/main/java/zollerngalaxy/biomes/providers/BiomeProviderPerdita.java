...
public class BiomeProviderPerdita extends BiomeProvider {
	...
	protected BiomeProviderPerdita() {
		body = ZGPlanets.planetPerdita;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderPerdita(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerPerdita.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderPerdita(World world) {
