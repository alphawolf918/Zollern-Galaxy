...
import zollerngalaxy.biomes.genlayers.atheon.GenLayerAtheon;
import zollerngalaxy.celestial.ZGPlanets;

public class BiomeProviderAtheon extends BiomeProvider {
	...
	protected BiomeProviderAtheon() {
		body = ZGPlanets.planetAtheon;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderAtheon(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerAtheon.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderAtheon(World world) {
