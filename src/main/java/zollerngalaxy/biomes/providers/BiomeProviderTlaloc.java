...
import zollerngalaxy.biomes.genlayers.tlaloc.GenLayerTlaloc;
import zollerngalaxy.celestial.ZGPlanets;

public class BiomeProviderTlaloc extends BiomeProvider {
	...
	protected BiomeProviderTlaloc() {
		body = ZGPlanets.planetTlaloc;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderTlaloc(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerTlaloc.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderTlaloc(World world) {
