...
import zollerngalaxy.biomes.genlayers.altum.GenLayerAltum;
import zollerngalaxy.celestial.ZGPlanets;

public class BiomeProviderAltum extends BiomeProvider {
	...
	protected BiomeProviderAltum() {
		body = ZGPlanets.planetAltum;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderAltum(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerAltum.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderAltum(World world) {
