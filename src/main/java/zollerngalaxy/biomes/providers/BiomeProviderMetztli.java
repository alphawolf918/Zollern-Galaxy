...
import zollerngalaxy.biomes.genlayers.metztli.GenLayerMetztli;
import zollerngalaxy.celestial.ZGPlanets;

public class BiomeProviderMetztli extends BiomeProvider {
	...
	protected BiomeProviderMetztli() {
		body = ZGPlanets.planetMetztli;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderMetztli(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerMetztli.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderMetztli(World world) {
