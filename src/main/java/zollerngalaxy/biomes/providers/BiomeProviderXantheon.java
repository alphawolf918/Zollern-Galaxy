...
import zollerngalaxy.biomes.genlayers.xantheon.GenLayerXantheon;
import zollerngalaxy.celestial.ZGPlanets;

public class BiomeProviderXantheon extends BiomeProvider {
	...
	protected BiomeProviderXantheon() {
		body = ZGPlanets.planetXantheon;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderXantheon(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerXantheon.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderXantheon(World world) {
