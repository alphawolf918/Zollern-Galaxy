...
import zollerngalaxy.biomes.genlayers.centotl.GenLayerCentotl;
import zollerngalaxy.celestial.ZGPlanets;

public class BiomeProviderCentotl extends BiomeProvider {
	...
	protected BiomeProviderCentotl() {
		body = ZGPlanets.planetCentotl;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderCentotl(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerCentotl.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderCentotl(World world) {
