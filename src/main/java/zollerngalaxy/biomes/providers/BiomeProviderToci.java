...
public class BiomeProviderToci extends BiomeProvider {
	...
	protected BiomeProviderToci() {
		body = ZGPlanets.planetToci;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderToci(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerToci.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderToci(World world) {
