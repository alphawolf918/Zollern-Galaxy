...
import zollerngalaxy.biomes.genlayers.kronos.GenLayerKronos;
import zollerngalaxy.celestial.ZGPlanets;

public class BiomeProviderKronos extends BiomeProvider {
	...
	protected BiomeProviderKronos() {
		body = ZGPlanets.planetKronos;
		biomeCache = new BiomeCache(this);
		biomesToSpawnIn = new ArrayList<>();
	}
	
	public BiomeProviderKronos(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerKronos.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}
	
	public BiomeProviderKronos(World world) {
