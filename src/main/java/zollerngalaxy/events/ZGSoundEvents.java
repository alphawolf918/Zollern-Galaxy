...
public class ZGSoundEvents {
	...
	// Sentinel Walker Mob
	public static final SoundEvent ENTITY_SENTINEL_WALKER_SAY = regSound("mob.sentinel.walker.say");
	public static final SoundEvent ENTITY_SENTINEL_WALKER_HURT = regSound("mob.sentinel.walker.hurt");
	public static final SoundEvent ENTITY_SENTINEL_WALKER_DIE = regSound("mob.sentinel.walker.die");
	...
	public static void init() {
		...
		registerSounds(ENTITY_SENTINEL_DRONE_SAY, ENTITY_SENTINEL_DRONE_HURT, ENTITY_SENTINEL_DRONE_DIE, ENTITY_SENTINEL_SHOOT, ENTITY_SENTINEL_HOUND_SAY, ENTITY_SENTINEL_HOUND_HURT, ENTITY_SENTINEL_HOUND_DIE, ENTITY_SENTINEL_WALKER_SAY, ENTITY_SENTINEL_WALKER_HURT, ENTITY_SENTINEL_WALKER_DIE);
	}
