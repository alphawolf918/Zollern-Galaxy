...
public class ZGSoundEvents {
	...
	public static void init() {
		registerSounds(ENTITY_ALIEN_AMBIENT, ENTITY_ALIEN_HURT, ENTITY_MUMMY_AMBIENT, ENTITY_MUMMY_HURT, ENTITY_MUMMY_DEATH, ENTITY_GALAXY_KNIGHT_SAY,
				...
				ENTITY_SHADOW_ALIEN_DEATH, ENTITY_FACELESS_AMBIENT, ENTITY_FACELESS_HURT, ENTITY_FACELESS_DEATH, MATERIAL_XENO_DIG, MATERIAL_XENO_STEP,
				SPIDERLING_EGG_HEARTBEAT, WEATHER_WIND);
	}
