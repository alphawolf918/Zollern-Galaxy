...
public class ZGSoundEvents {
	...
	// Sentinel Mob
	public static final SoundEvent ENTITY_SENTINEL_SAY = regSound("mob.sentinel.say");
	public static final SoundEvent ENTITY_SENTINEL_HURT = regSound("mob.sentinel.hurt");
	public static final SoundEvent ENTITY_SENTINEL_DIE = regSound("mob.sentinel.die");
	...
	public static void init() {
		...
		registerSounds(ENTITY_SENTINEL_SAY, ENTITY_SENTINEL_HURT, ENTITY_SENTINEL_DIE, ENTITY_SENTINEL_SHOOT);
	}
