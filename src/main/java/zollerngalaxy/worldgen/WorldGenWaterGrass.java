...
public class WorldGenWaterGrass extends ZGWorldGenMaster {
	
	private IBlockState flower;
	
	public WorldGenWaterGrass(ZGWaterGrass tallgrass) {
	...
	public boolean generate(World world, Random rand, BlockPos pos) {
		for (int i = 0; i < 128; ++i) {
			...
			if (world.isAirBlock(pos1) && (pos1.getY() < 255) && ((ZGWaterGrass) this.flower.getBlock()).canBlockStay(world, pos1, this.flower)) {
