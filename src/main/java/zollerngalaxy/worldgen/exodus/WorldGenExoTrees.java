 ...
 * redistribute it.
 */
package zollerngalaxy.worldgen.exodus;
...
public class WorldGenExoTrees extends WorldGenAbstractTree {
	...
	public WorldGenExoTrees(boolean notify, int minTreeHeightIn, IBlockState woodMeta, IBlockState p_i46446_4_, boolean growVines) {
		super(notify);
	...
	private void placeFruit(World worldIn, int p_181652_2_, BlockPos pos, EnumFacing side) {
		...
		// .withProperty(EdenFruit.AGE, Integer.valueOf(p_181652_2_)).withProperty(EdenFruit.FACING,
		// side));
	}
