...
public class DungeonConfigurationZG extends DungeonConfiguration {
	...
	public DungeonConfigurationZG() {
	}
	
	public DungeonConfigurationZG(IBlockState brickBlock, int yPosition, int hallwayLengthMin, int hallwayLengthMax, int hallwayHeight, int roomHeight, Class<?> bossRoom, Class<?> treasureRoom, ResourceLocation lootTableIn, ResourceLocation dungeonLootTableIn, IBlockState chestStateIn, IBlockState spawnerStateIn, IBlockState fluidStateIn, ResourceLocation mobsIn) {
		...
		this.dungeonLoot = dungeonLootTableIn;
		this.chestState = chestStateIn;
		this.spawnerState = spawnerStateIn;
		this.fluidState = fluidStateIn;
		this.mobs = mobsIn;
	}
	...
	public ResourceLocation getDungeonChestLootTable() {
	...
	public IBlockState getSpawnerState() {
	...
	public DungeonConfigurationZG getConfiguration() {
		return this;
	}
}