...
public abstract class SizedPieceTlaloc extends DirectionalPieceTlaloc {
	
	protected int sizeX;
	protected int sizeY;
	protected int sizeZ;
	
	public SizedPieceTlaloc() {
	}
	
	public SizedPieceTlaloc(DungeonConfigurationTlaloc configuration, int sizeX, int sizeY, int sizeZ, EnumFacing direction) {
