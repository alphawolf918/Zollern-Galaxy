...
public class RoomEmptyTlaloc extends SizedPieceTlaloc {
	
	public RoomEmptyTlaloc() {
	}
	
	public RoomEmptyTlaloc(DungeonConfigurationTlaloc configuration, Random rand, int blockPosX, int blockPosZ, int sizeX, int sizeY, int sizeZ, EnumFacing entranceDir) {
