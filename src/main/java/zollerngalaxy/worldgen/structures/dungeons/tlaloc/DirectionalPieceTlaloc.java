...
public abstract class DirectionalPieceTlaloc extends PieceTlaloc {
	
	private EnumFacing direction;
	
	public DirectionalPieceTlaloc() {
	}
	
	public DirectionalPieceTlaloc(DungeonConfigurationTlaloc configuration, EnumFacing direction) {
		super(configuration);
	...
	public PieceTlaloc getCorridor(Random rand, DungeonStartTlaloc startPiece, int maxAttempts, boolean small) {
		...
		return new CorridorTlaloc(this.configuration, rand, blockX, blockZ, sizeX, small ? 3 : this.configuration.getHallwayHeight(), sizeZ, randomDir);
	}
}