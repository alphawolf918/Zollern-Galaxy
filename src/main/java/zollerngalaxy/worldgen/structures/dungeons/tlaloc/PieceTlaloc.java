...
public abstract class PieceTlaloc extends StructureComponent {
	
	protected DungeonConfigurationTlaloc configuration;
	protected static DungeonConfigurationTlaloc DUNGEON_CFG;
	
	public PieceTlaloc() {
	}
	
	public PieceTlaloc(DungeonConfigurationTlaloc configuration) {
	...
	protected void readStructureFromNBT(NBTTagCompound tagCompound, TemplateManager manager) {
		if (this.configuration == null) {
			this.configuration = new DungeonConfigurationTlaloc();
