...
public abstract class DirectionalPieceEden extends PieceEden {
	
	private EnumFacing direction;
	
	public DirectionalPieceEden() {
	}
	
	public DirectionalPieceEden(DungeonConfigurationEden configuration, EnumFacing direction) {
		super(configuration);
	...
	public PieceEden getCorridor(Random rand, DungeonStartEden startPiece, int maxAttempts, boolean small) {
		...
		return new CorridorEden(this.configuration, rand, blockX, blockZ, sizeX, small ? 3 : this.configuration.getHallwayHeight(), sizeZ, randomDir);
	}
}