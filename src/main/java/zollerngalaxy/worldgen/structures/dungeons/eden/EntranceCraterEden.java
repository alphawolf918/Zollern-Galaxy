...
public class EntranceCraterEden extends SizedPieceEden {
	...
	public EntranceCraterEden(World world, DungeonConfigurationEden configuration, Random rand, int blockPosX, int blockPosZ) {
	...
	public PieceEden getNextPiece(DungeonStartEden startPiece, Random rand) {
		return new RoomEntranceEden(this.configuration, rand, this.boundingBox.minX + this.boundingBox.getXSize() / 2, this.boundingBox.minZ + this.boundingBox.getZSize() / 2);
	}
}