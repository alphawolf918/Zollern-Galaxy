...
public class RoomEmptyEden extends SizedPieceEden {
	
	public RoomEmptyEden() {
	}
	
	public RoomEmptyEden(DungeonConfigurationEden configuration, Random rand, int blockPosX, int blockPosZ, int sizeX, int sizeY, int sizeZ, EnumFacing entranceDir) {
