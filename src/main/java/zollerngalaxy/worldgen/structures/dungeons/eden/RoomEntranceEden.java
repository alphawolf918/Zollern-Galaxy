...
public class RoomEntranceEden extends SizedPieceEden {
	
	public RoomEntranceEden() {
	}
	
	public RoomEntranceEden(DungeonConfigurationEden configuration, Random rand, int blockPosX, int blockPosZ) {
