...
public class EntranceCraterZG extends SizedPieceZG {
	...
	public PieceZG getNextPiece(DungeonStartZG startPiece, Random rand) {
		return new RoomEntranceZG(this.configuration, rand, this.boundingBox.minX + this.boundingBox.getXSize() / 2, this.boundingBox.minZ + this.boundingBox.getZSize() / 2);
	}
}