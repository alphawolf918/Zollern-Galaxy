...
// }
//
// protected StructureBoundingBox getExtension(EnumFacing direction, int length,
// int width) {
...
// sizeX = width;
// sizeZ = length;
// blockX = this.boundingBox.minX + (this.boundingBox.maxX -
...
// blockZ = this.boundingBox.minZ + (this.boundingBox.maxZ -
...
// break;
// }
// return new StructureBoundingBox(blockX, this.configuration.getYPosition(),
// blockZ, blockX
// + sizeX, this.configuration.getYPosition() +
// this.configuration.getHallwayHeight(),
// blockZ + sizeZ);
// }
//
