...
public class MapGenVillageHarran extends MapGenStructure {
	
	public static List<Biome> VILLAGE_SPAWN_BIOMES = Arrays.asList(new Biome[] { BiomeAdaptive.biomeDefault });
	...
	protected StructureStart getStructureStart(int chunkX, int chunkZ) {
		return new MapGenVillageHarran.Start(this.world, this.rand, chunkX, chunkZ, this.size);
	}
