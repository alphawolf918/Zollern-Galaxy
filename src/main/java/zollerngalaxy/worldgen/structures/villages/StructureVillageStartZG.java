...
public class StructureVillageStartZG extends StructureStart {
	
	public StructureVillageStartZG() {
	}
	
	public StructureVillageStartZG(World par1World, Random par2Random, int par3, int par4, int par5) {
		super(par3, par4);
		
		final ArrayList<StructureVillagePieceWeightZG> var6 = StructureVillagePiecesZG.getStructureVillageWeightedPieceList(par2Random, par5);
		final StructureComponentVillageStartPieceZG var7 = new StructureComponentVillageStartPieceZG(par1World.getBiomeProvider(), 0, par2Random, (par3 << 4) + 2,
				(par4 << 4) + 2, var6, par5);
		...
		while (var13.hasNext()) {
			...
			if (!(var12 instanceof StructureComponentVillageRoadPieceZG)) {
				++var10;
			}
		}
	}
