...
public class TileEntityTier4TreasureChestZGRenderer extends TileEntitySpecialRenderer<TileEntityTier4TreasureChestZG> {
	
	private static final ResourceLocation treasureChestTexture = new ResourceLocation(ZGInfo.MOD_ID, "textures/models/treasure_chest_eden.png");
	
	private final ModelTreasureChest chestModel = new ModelTreasureChest();
	
	@Override
	public void render(TileEntityTier4TreasureChestZG chest, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		int var9;
		...
		this.bindTexture(TileEntityTier4TreasureChestZGRenderer.treasureChestTexture);
